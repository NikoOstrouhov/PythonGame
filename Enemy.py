...
class Shooter(Enemy):
    def __init__(self):
        super().__init__()
        self.sprite = arcade.Sprite("SpaceShips/Nairan - Bomber - Base.png",1.5)
        self.health = 2
...
class Aimer(Shooter):
    def __init__(self):
        super().__init__()
        self.sprite = arcade.Sprite("SpaceShips/Nairan - Frigate - Base.png", 1.5)
        self.health = 5
        self.sprite.angle = 180
        self.bullet_speed = 7
...
class Boss(Shooter):
    def __init__(self):
        super().__init__()
        self.sprite = arcade.Sprite("SpaceShips/Nairan - Torpedo Ship - Base.png", 3.5)
        self.health = 30
        self.sprite.angle = 180
        self.bullet_speed = 7
